...
def test_remove_arabic_punctuations(inp_text, target_text):
    cleaner = TextCleaner(inp_text)
    assert cleaner.remove_arabic_punctuations().text.strip() == target_text.strip()
...
def test_remove_english_punctuations(inp_text, target_text):
    cleaner = TextCleaner(inp_text)
    assert cleaner.remove_english_punctuations().text.strip() == target_text.strip()
